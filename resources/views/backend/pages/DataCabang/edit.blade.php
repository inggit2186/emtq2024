...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                <form class="form form-horizontal" action="{{ route('update.cabang', $cmtq->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') ?? $cmtq->kategori }}" name="name" placeholder="Name">
                                @error('name')
							...
							<div class="col-md-8 form-group">
								...
								<option value="0" @if($cmtq->penanya == 0 ) selected @endif
                                    ...
                                    Tidak Ada</option>
								<option value="1" @if($cmtq->penanya == 1 ) selected @endif
                                    class="block w-full px-4 py-3 border-2 border-transparent text-gray-800 rounded-lg focus:border-blue-500 focus:outline-none">
                                    Ada</option>
								</select>
                                @error('penanya')
