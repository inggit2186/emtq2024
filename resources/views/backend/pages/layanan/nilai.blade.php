...
<div class="page-content">
    <section class="section">
			<div class="card">
            <div class="card-body">
			<a href="{{ route('print.laporan', Crypt::Encrypt($cmtq->id)) }}" target=_blank class="btn btn-primary"><i class="fas fa-print"></i> Nilai</a> &nbsp; &nbsp;
			<a href="{{ route('print.laporan2', Crypt::Encrypt($cmtq->id)) }}" target=_blank class="btn btn-primary"><i class="fas fa-print"></i>Finalis </a> &nbsp; &nbsp;
                @if (session('status'))
			...
			<br />
				...
				@php
					...
					$peserta = App\Models\Peserta::with(['cmtq','gmtq'])->where('golongan_id',$gmtq2->id)->orderBy('total', 'DESC')->orderBy('id', 'ASC')->get();
				...
				@php
					...
					$peserta2 = App\Models\Peserta::with(['cmtq','gmtq'])->where('golongan_id',$gmtq2->id)->orderBy('total', 'DESC')->orderBy('id', 'ASC')->get();
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>	
							...
							@php 
								$nilai = App\Models\Nilai::with(['cmtq','gmtq','bidang','peserta'])->where(['peserta'=> $peserta2->nama, 'status' => 0])->get();
							@endphp
