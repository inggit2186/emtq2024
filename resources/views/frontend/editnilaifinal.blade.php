    ...
    <div class="max-w-5xl mt-20  mx-auto">
        <div class="flex flex-col justify-between items-center md:flex-row">
            <div class="w-full mt-16 md:mt-0 ">
                <form action="{{route('edit.storefinal')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div
                       ...
                       @enderror
						...
						@php
							$penanya = App\Models\Nilai::where(['peserta'=> $peserta->nama, 'status' => 2])->whereNotNull('penanya')->groupBy('penanya')->first();
						@endphp
					   ...
					   <br />
						...
						@php $i=0; @endphp
							...
							@for($i==0;$i < $nilai->hakim;$i++)
								@php
									$value = App\Models\Nilai::where(['peserta' => $peserta->nama, 'status' => 2, 'bidang_id' => $nilai->id])->skip($i)->first();
								@endphp
								<tr>
