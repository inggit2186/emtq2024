...
@section('title', 'Cek Permintaan Layanan | Kantor KEMENAG Tanah Datar')
@section('content')
        ...
        <div class="flex flex-col justify-between items-center md:flex-row">
            <div class="w-full mt-16  md:mt-0 ">
                ...
                <div
                    ...
                    <h3 class="mb-6 text-2xl font-medium text-center">Cari <strong>Permintaan / Konsultasi</strong> Anda
                    </h3>
                    <form action="{{route('pengaduan.search')}}" method="POST">
                        ...
                        <div class="block mb-4 border border-gray-200 rounded-lg">
                            <input type="text" name="keyword" id="nis"
                                ...
                                placeholder="Silahkan masukkan Kata Kunci">
                        </div>
                        <div class="block">
                            <button
					...
					<div class="max-w-2xl mt-5 mx-auto px-8 py-4 bg-white  rounded-lg shadow-lg">
                        ...
                        <div class="mt-2">
                            <p
                                ...
                                @php
								if (!empty($item->judul)){
                                    echo(strip_tags($item->judul));
								}else{
									echo(strip_tags($item->layanan->nama));
								}
                                @endphp</p>
                        ...
                        <div class="flex">
                            @auth
                                ...
                                @endif
                                @if ($item->user_id === auth()->user()->nomor_induk)
                                    @if ($item->status === 'PENDING')
                                    <div class="flex">
